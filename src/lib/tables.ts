import type { Table } from "../components/models.ts";
import { parseDiceString, rollDice } from "./util.ts";
...
export const MeleeDemon: Table = {
  ...
  rows: [
    ...
    },
    {
      floor: 3,
      text:
        "Your weapon cuts so deep into an object that it gets stuck. Pulling it free requires a STR roll (counts as an action)",
    },
    {
      floor: 4,
    ...
    },
    {
      floor: 5,
      text:
        "You slam your weapon into something hard and damage it. Any use of the weapon gets a bane until it is repaired by an artisan.",
    },
...
export const RangedDemon: Table = {
  ...
  rows: [
    { floor: 1, text: "You drop your weapon at your feet. Picking it up is an action." },
    {
      floor: 2,
      text:
        "You run out of arrows and must get more before you can use the weapon again. Re-roll for sling or throwing weapons.",
    },
    ...
    { floor: 4, text: "You break your weapon. Any use of the weapon gets a bane until it is repaired by an artisan." },
    {
      floor: 5,
      text:
        "You accidentally hit a random player character or friendly NPC. Roll for damage as usual, including damage bonus.",
    },
...
export const MagicalMishap: Table = {
  ...
  rows: [
    ...
    },
    {
      floor: 11,
      text:
        "You vomit a frog the moment you tell a lie. Roll D4 every morning. On a 1, the effect wears off. It can also be lifted with DISPEL.",
    },
    {
      floor: 12,
      text:
        "Any gold or silver you touch withers into dust. Roll D4 every morning. On a 1, the effect wears off. It can also be lifted with DISPEL.",
    },
    {
      floor: 13,
      text:
        "The spell blinds you, and you act as if in total darkness (page 52). Roll D4 every morning. On a 1, you recover. The effect can also be lifted with DISPEL.",
    },
    {
      floor: 14,
      text:
        "You are struck by amnesia and forget who you and the other player characters are. The effect must be roleplayed. Roll D4 every morning. On a 1, your memory returns.",
    },
    {
      floor: 15,
    ...
    },
    {
      floor: 17,
      text:
        "You turn into an animal. Roll D6. 1: cat, 2: fox, 3: goat, 4: wolf, 5: deer, 6: bear. You get stats according to the table on page 99 and cannot speak, but you retain your mental acuity. Roll a D4 every morning. On a 1, you revert back to your original form.",
    },
    {
      floor: 18,
      text:
    ...
    },
    {
      floor: 19,
      text:
        "You become one category older, for example from adult to old. Your attributes and derived ratings change as per the table on page 24, but your skill levels do not. If you were already old, you become very frail and get −2 STR and CON. The effect is permanent and you age normally from your new age.",
    },
    {
      floor: 20,
      text:
        " Your magic attracts a demon (page 85) from another dimension. The demon shows up within the next shift and attacks or causes some kind of trouble. The details are up to the GM.",
    },
  ],
};
